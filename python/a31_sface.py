...
parser.add_argument('--model', '-m', type=str, default='/home/inteee/opencvZoo2/data/face_recognition_sface_2021dec.onnx',
...
if __name__ == '__main__':
    ...
    detector = YuNet(modelPath='/home/inteee/opencvZoo2/data/face_detection_yunet_2023mar.onnx',
                     inputSize=[320, 320],
                     confThreshold=0.9,
                     nmsThreshold=0.3,
                     topK=5000,
    ...
    # img 1 처리
    img1 = cv.imread("/home/inteee/opencvZoo2/data/face/20.jpg")
    #img2 = cv.imread("/home/inteee/opencvZoo2/data/face/02.jpg")
    w, h = img1.shape[0:2]
