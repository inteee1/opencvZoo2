...
class LogoEvent:
    def __init__(self, screen_width = 800, screen_height = 600):
        ...
        self.mouse_on = False
        self.selected_channel = 'r'  # 'r', 'g', 'b' 중 선택된 채널
        self.bgr_values = [0, 0, 0]  # [B, G, R] 값 저장
    ...
    def draw_bgr_info(self, img):
        ...
        cv2.putText(img, info_text, (10, self.screen_height-30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
        return img
