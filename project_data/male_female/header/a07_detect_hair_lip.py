...
face_cascade = cv2.CascadeClassifier("/home/inteee/opencvZoo2/data/haarcascade_frontalface_alt2.xml")  # 정면 검출기
eye_cascade = cv2.CascadeClassifier("/home/inteee/opencvZoo2/data/haarcascade_eye.xml")  # 눈 검출기
