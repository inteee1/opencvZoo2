...
def preprocessing(no):
    print("/home/inteee/opencvZoo2/data/face/%02d.jpg" % no)
    image = cv2.imread("/home/inteee/opencvZoo2/data/face/%02d.jpg" % no, cv2.IMREAD_COLOR)
...
def correct_image(image, face_center, eye_centers):
    ...
    size = image.shape[1::-1] # 끝까지 자동으로 계산
