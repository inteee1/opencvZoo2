...
from project_data.temp_project.mediapipe import MPHandPose, MPPalmDet, visualize
...
class VideoSprite(Sprite):
    ...
    def mp_hand_pose_process(self, ):
        palm_detector = MPPalmDet(modelPath='/home/inteee/opencvZoo2/data/palm_detection_mediapipe_2023feb.onnx',
                              nmsThreshold=0.3,
                              scoreThreshold=0.6,
    ...
    def _handle_hand_pose(self):
        ...
        ret, self.image = self.cap.read()
        if ret:
            self.image = self.mp_hand_pose_process()
